...
**16)** ’päätoimipaikalla’ **teknisten välineiden ja teknologioiden** käytön näkökulmasta paikka, jossa pääasiallinen käsittely tapahtuu.

**17)** ’edustajalla’ unioniin sijoittautunutta luonnollista henkilöä tai oikeushenkilöä, jonka rekisterinpitäjä tai henkilötietojen käsittelijä on nimennyt kirjallisesti toimimaan lukuunsa 27 artiklan nojalla ja joka edustaa rekisterinpitäjää tai henkilötietojen käsittelijää.

**18)** ’yrityksellä’ taloudellista toimintaa harjoittavaa luonnollista henkilöä tai oikeushenkilöä sen oikeudellisesta muodosta riippumatta.

**19)** ’konsernilla’ määräysvaltaa käyttävää yritystä ja sen määräysvallassa olevia yrityksiä.

**20)** ’yritystä koskevilla sitovilla säännöillä’ henkilötietojen suojeluperiaatteita, joita jonkin jäsenvaltion alueelle sijoittautunut rekisterinpitäjä tai henkilötietojen käsittelijä on sitoutunut noudattamaan.
...
**24)** ’merkityksellisellä ja perustellulla vastalauseella’ vastalausetta päätösehdotukseen.

**25)** ’tietoyhteiskunnan palveluilla’ palveluja, jotka määritellään Euroopan parlamentin ja neuvoston direktiivin (EU) 2015/1535 1 artiklan 1 kohdan b alakohdassa.
...
- **Henkilötietojen käsittely** vaatii syvällistä ymmärrystä **automaattisista ja manuaalisista tietojenkäsittelyprosesseista**.  
